        ...
        <div className="min-h-screen bg-black text-white p-8 lg:p-12">
            <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-white/40 text-[10px] font-black uppercase tracking-widest mt-2 max-w-md">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <aside className="lg:col-span-1 space-y-6">
                    <div className="p-8 bg-white/[0.03] border border-white/10 rounded-[40px] relative overflow-hidden group">
                        ...
                        <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-1">Pricing Health</p>
                    ...
                    <div className="p-8 bg-white/[0.03] border border-white/10 rounded-[40px]">
                        <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-4">Gemini Insight</p>
                ...
                <div className="lg:col-span-3 space-y-6">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <h2 className="text-xs font-black uppercase tracking-widest text-white/40">Product Intelligence Index</h2>
                    </div>
                            ...
                            return (
                                <div key={product._id} className="group bg-white/[0.02] border border-white/10 rounded-[40px] p-8 hover:bg-white/[0.04] hover:border-white/20 transition-all flex flex-col md:flex-row md:items-center gap-8">
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-4 mt-4 text-[10px] font-black uppercase text-white/40 tracking-[0.2em]">
                                    ...
                                    <div className="flex items-center gap-8">
                                        {intel ? (
                                            <div className="text-right">
                                                <p className="text-[10px] font-black text-white/40 uppercase mb-1">Gap Analysis</p>
                                                <p className={cn(
                                        ...
                                        <div className="flex flex-col gap-2">
                                            {isAtRisk ? (
                                                <button className="px-6 py-3 bg-red-500/10 border border-red-500/20 text-red-500 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all">
                                                    Reprice to Match
                                                </button>
                                            ) : (

        ...
        <div ref={containerRef} className="max-w-7xl mx-auto px-8 py-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1 space-y-4">
                    <h4 className="text-[10px] font-black uppercase text-white/40 tracking-widest pl-4">Available for Analysis</h4>
                    <div className="space-y-2 h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                        {products.map((product: any) => (
                            ...
                            >
                                ...
                                <p className="text-[10px] font-black text-white/40 uppercase">${product.price}</p>
                            </button>
                        ))}
                    </div>
                </div>
...
function CompareColumn({ product, onRemove }: { product: any; onRemove: () => void }) {
    ...
    return (
        <div className="bg-white/[0.03] border border-white/10 rounded-[40px] p-8 flex flex-col relative group">
            <button
                onClick={onRemove}
                className="absolute top-4 right-4 p-2 bg-white/5 rounded-full text-white/20 hover:text-red-500 hover:bg-red-500/10 transition-all z-20"
            >
            ...
            <div className="space-y-8 flex-1">
                <div className="p-4 bg-white/5 rounded-3xl">
                    <p className="text-[10px] font-black text-white/40 uppercase mb-2">Price Point</p>
                    <p className="text-3xl font-black">${product.price}</p>
                </div>

                <div className="space-y-4">
                    <div className="flex justify-between items-end">
                        <p className="text-[10px] font-black text-white/40 uppercase">Quality Score</p>
                ...
                <div className="space-y-2">
                    <p className="text-[10px] font-black text-white/40 uppercase">Platform Trust</p>
